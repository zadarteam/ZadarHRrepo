...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR red][I][B]Zadar TM [COLOR deepskyblue][I] Wizard[/I][/B][/COLOR]'
BUILDERNAME = 'Zadar TM Wizard '
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it.
BUILDFILE ='https://zadarbuild.com.hr/BuildzipZD/KODI-19/builds.xml'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Zadar TM [/B][/COLOR][COLOR {color2}]Wizard 19[COLOR {color1}]) [/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR red][I][B]Zadar TM [COLOR deepskyblue][I] Wizard[/I][/B][/COLOR]'
# url to image if using Image 424x180
HEADERIMAGE = 'https://zadarbuild.com.hr/slike/wizardslike/fanart.png'
# Font for Notification Window
FONTSETTINGS = 'Font13'
# Background for Notification Window
BACKGROUND = 'https://zadarbuild.com.hr/slike/wizardslike/fanart.png'
#########################################################
