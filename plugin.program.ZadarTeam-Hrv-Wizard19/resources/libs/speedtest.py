...
def speedtest(list=False, mini=None, server=None, share=True, simple=False, src=None, timeout=10, units=('bit', 8),
              version=False):
    ...
    dp.create('{0}: [COLOR {1}]Speed Test[/COLOR]\n'.format(CONFIG.ADDONTITLE, CONFIG.COLOR1), line1)
    dp.update(0)
    logging.log('Retrieving speedtest.net configuration...', level=xbmc.LOGDEBUG)
    line2 = '[COLOR {0}]Retrieving speedtest.net configuration...[/COLOR]\n'.format(CONFIG.COLOR2)
    ...
    line2 = '\n[COLOR {0}]Selecting best server based on latency...[/COLOR]'.format(CONFIG.COLOR2)
    dp.update(8, line2)
    ...
    line3 = '\n\n[COLOR {0}]Testing download speed...[/COLOR]'.format(CONFIG.COLOR2)
    dp.update(15, line3)
    ...
    line3 = '\n[COLOR {0}]Testing upload speed...[/COLOR]'.format(CONFIG.COLOR2)
    ...
    line3 = '\n[COLOR %s]Getting results...[/COLOR]' % CONFIG.COLOR2
    ...
    if share:
        ...
        apiData = [
            ...
            'hash={0}'.format(
                hashlib.md5('{0}-{1}-{2}-{3}'.format(ping, ulspeedk, dlspeedk, '297aae72').encode('utf-8')).hexdigest())
        ]
        ...
        logging.log('Share results: {0}://www.speedtest.net/result/{1}.png'.format(scheme, resultid[0]),
                    level=xbmc.LOGDEBUG)
