...
def all_with_progress(_in, _out, dp, ignore, title):
    ...
    for item in zin.infolist():
        ...
        line1 = '{0} [COLOR {1}][B][Errors:{2}][/B][/COLOR]'.format(title,
                                                                    CONFIG.COLOR2,
                                                                    errors)
        line2 = '\n[COLOR {0}][B]File:[/B][/COLOR] [COLOR {1}]{2}/{3}[/COLOR] '.format(CONFIG.COLOR2,
                                                                                       CONFIG.COLOR1,
                                                                                       count,
                                                                                       int(nFiles))
        line2 += '\n[COLOR {0}][B]Size:[/B][/COLOR] [COLOR {1}]{2}/{3}[/COLOR]'.format(CONFIG.COLOR2,
                                                                                       CONFIG.COLOR1,
                                                                                       tools.convert_size(size),
                                                                                       zipsize)
        line3 = '\n[COLOR {0}]{1}[/COLOR]'.format(CONFIG.COLOR1, item.filename)
