...
ADDONTITLE     = '[B][COLOR red][COLOR white]Zadar Team Wizard[COLOR blue][/COLOR][/B]'
BUILDERNAME    = 'cMaN'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'repository.ZadarHRrepo', 'My_Builds', 'backupdir']
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Welcome to the Zadar Team Wizard.'
...
# Font size of header
FONTHEADER     = 'Font25'
HEADERMESSAGE  = 'Zadar Team Wizard'
