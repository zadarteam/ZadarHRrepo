...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[B][COLOR aqua]Zadar TEAM Wizard[/COLOR][/B]'
BUILDERNAME = 'Zadar'
EXCLUDES = [ADDON_ID, 'repository.Zadar', 'My_Builds', 'backupdir']
...
#           ICONSETTINGS  = 'https://zadarbuild.com.hr/BuildzipZD/icon.png'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Zadar Matrix - [/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing the [CR]Zadar TEAM Wizard'
...
BACKGROUND = 'https://zadarbuild.com.hr/BuildzipZD/fanart.jpg'
#########################################################
