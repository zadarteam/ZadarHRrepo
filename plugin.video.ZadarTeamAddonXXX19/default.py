...
url_principal = 'http://zadarbuild.com.hr/Zadar19/ZADAR.TEAM.ADDON/xxx.jpg'
...
def resolver(link):
    ...
    try:
        if not link_decoded.startswith("plugin://plugin") and link_decoded.startswith('https://drive.google.com') == True:
            ...
            resolved = link_decoded
        elif not link_decoded.startswith("plugin://plugin") and link_decoded.find('.xml') >= 0 and not link_decoded.startswith('magnet:?xt=') == True and not link_decoded.find('.torrent') >= 0:
            resolved = link_decoded            
            ...
            for i in items:
                ...
                if mode == 0:
                    try:
                        ...
                        pass
                elif mode == 11 or mode == 16 or mode == 17 or mode == 18 or mode == 19:
                    try:
